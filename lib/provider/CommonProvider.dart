...
//Applicants
  ...
  LoadAppli(Applicant app) {
    _FullName = app.FullName;
    _Age = app.Age;
    _HighestQualifiaction = app.HighestQualifiaction;
    _ExpectedSalary = app.ExpectedSalary;
    _AboutYou = app.AboutYou;
    _CVUploadedLink = app.CVUploadedLink;
    
    _ApplicantID = app.ApplicantID;
