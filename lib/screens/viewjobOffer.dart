...
import 'AdminJobView.dart';
import 'ApplicantViewInsideApplication.dart';

class ViewJobOffer extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Manage Job Applicants"),
        ),
        body: (appli != null)
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    subtitle: Text(appli[index].HighestQualifiaction),
                          ...
                          Navigator.push(
                              ...
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (BuildContext context,
                                      Animation<double> animation,
                                      Animation<double> secAnimation) {
                                    return AdminJobView(appli[index]);
                                  }));
                        }),
                    isThreeLine: true,
                    onTap: () {
